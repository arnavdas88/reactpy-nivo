...
ColorType = Union[InheritColor, ThemeColor, str, Callable]

SIMPLE_CURVES = ['linear', 'natural', 'step', 'stepAfter', 'stepBefore']
ADVANCED_CURVES = ['basis', 'cardinal', 'catmullRom', 'monotoneX', 'monotoneY']

CurveType = Literal[*SIMPLE_CURVES, *ADVANCED_CURVES]

BlendMode = Literal['normal', 'multiply', 'screen', 'overlay', 'darken', 'lighten', 'color-dodge', 'color-burn', 'hard-light', 'soft-light', 'difference', 'exclusion', 'hue', 'saturation', 'color', 'luminosity']